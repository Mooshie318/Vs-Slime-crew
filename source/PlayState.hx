...
class PlayState extends MusicBeatState
{
	...
	var dieText:FlxText; // for the text in slime attack
	...
	override public function create()
	{
		...
		switch(SONG.song.toLowerCase())
		{
			default:
			{
					...
					dieText = new FlxText(0, 580, 0);
					dieText.text = '';
					dieText.setFormat(Paths.font('vcr.ttf'), 50, FlxColor.WHITE, CENTER);
					dieText.setBorderStyle(OUTLINE, FlxColor.BLACK, 3);
	...
	override function beatHit()
	{
		...
		if (curSong == 'slime-attack')
		{
			switch(curBeat)
			{
				...
				case 278:
				{
					dieText.text = 'fucking';
				}
				case 280:
				{
					dieText.x = dieText.x - 200;
					dieText.text = 'DIEEEEEEEEEEEEE!?!?';
				}
				case 284:
				{
